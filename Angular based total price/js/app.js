...
app.controller("orderGenerator", function($scope)
 ...
 for(count=0;count<$scope.selectedItems.length;count++){
	...
	var header = "<h3>Yummys!!</h3><h5>123, 5th kala kua, <br>Alwar, IND - 301001.</h5><center> <h4>Retail Invoice</h4></center>";
	document.getElementById("shopHeading").innerHTML = header;
	document.getElementById("grandTotal").innerHTML = "Grand Total: "+grandTotal+"Rs.";
	var r = new Array(), j = -1;
 ...
 var value = (r.join(''));
 	var message ="<table class=\"table table-hover\"><tr><th>Item</th><th>Price/Unit</th><th>Quantity</th><th>Amount(Rs.)</th></tr>"+value+"</table>";
